#!/bin/bash
# Run this script with: sudo bash /home/administrator/FLXContabilidad/setup_infrastructure.sh
...
server {
    ...
    root /home/administrator/FLXContabilidad/frontend/dist;
    index index.html;
...
User=administrator
Group=www-data
WorkingDirectory=/home/administrator/FLXContabilidad/backend
Environment="PATH=/home/administrator/FLXContabilidad/venv/bin"
EnvironmentFile=/home/administrator/FLXContabilidad/.env
ExecStart=/home/administrator/FLXContabilidad/venv/bin/gunicorn --config gunicorn.conf.py app:app
